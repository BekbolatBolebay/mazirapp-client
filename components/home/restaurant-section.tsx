              ...
              <div className="relative h-40 bg-muted">
                {restaurant.cover_image_url ? (
                  <Image
                    ...
                    alt={locale === 'ru' && restaurant.name_ru ? restaurant.name_ru : restaurant.name}
                    fill
              ...
              <CardContent className="p-4">
                <div className="flex items-start justify-between mb-2">
                  <div className="flex-1">
                    <h3 className="font-bold text-base mb-1">
                      {locale === 'ru' && restaurant.name_ru ? restaurant.name_ru : restaurant.name}
                    </h3>
                    <p className="text-sm text-muted-foreground line-clamp-1">
                      {locale === 'ru' && restaurant.description_ru ? restaurant.description_ru : restaurant.description}
                    </p>
                  </div>
                ...
                <div className="flex items-center gap-4 text-sm text-muted-foreground">
                  <div className="flex items-center gap-1">
                    ...
                    <span>
                      {restaurant.delivery_time_min}-{restaurant.delivery_time_max} {t.restaurant.deliveryTime}
                    </span>
                  </div>
