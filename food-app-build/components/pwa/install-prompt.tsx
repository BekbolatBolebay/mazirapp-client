...
export function InstallPrompt() {
    ...
    return (
        <AnimatePresence>
            ...
            >
                <Card className="bg-white dark:bg-zinc-900 border-primary/20 shadow-2xl rounded-2xl overflow-hidden">
                    <CardContent className="p-4">
                        <div className="flex items-start gap-3">
                            ...
                            <button
                                ...
                                className="w-10 h-10 -mr-2 -mt-2 rounded-full hover:bg-zinc-100 dark:hover:bg-zinc-800 flex items-center justify-center transition-colors cursor-pointer touch-manipulation z-[110]"
                                aria-label="Close"
                            >
